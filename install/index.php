...
function home_base_url()
{
   ...
   $url = protochol();
    ...
    $final_url = str_replace(['install/index.php','install/','install',],['','',''],$url);

    if (substr($final_url,-1,strlen($final_url)) === '/'){
...
$extensions = [
    ...
    'Tokenizer', 'XML', 'cURL',
    'fileinfo','json','intl','zip','gd','openssl','xml'
];
...
<head>
    ...
    <link rel="stylesheet" href="../assets/frontend/css/bootstrap.min-v4.6.0.css">
    <link rel="stylesheet" href="../assets/frontend/css/line-awesome.min-v1.3.0.css">
    <?php  if(isHttps()):  ?>
    ...
    <div class="get-support">
        <div class="icon-wrap">
            <ul class="support-list">
                <li><a href="http://bytesed.com/">Visit Website</a></li>
                <li><a href="https://bytesed.com/contact/" target="_blank">Contact Support</a></li>
            </ul>
                    ...
                    <form id="msform" action="index.php" method="post">
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <table class="requirement-check">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php
                                        $phpversion = PHP_VERSION_ID >= 80100;
                                        if ($phpversion) {
                            ...
                            <button type="button"
                                ...
                                <?php  if ($ext_errors > 0 || !$phpversion): ?> disabled <?php endif;?>>
                                Next
                            </button>
                        </div>
                        <div class="content-wrap with-step">
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <?php if ($database_errors > 0):?>
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">your installation <strong>database.sql</strong> file is missing, re-download files from codecanyon, or
                                    <a href="https://bytesed.com/support-center/">contact support</a> </div>
                            <?php endif;?>
                            <button type="button" class="previous action-button">Previous</button>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copyright-inner">
                    &copy; <?php echo date('Y')?> All Right Reserved By <a href="https://bytesed.com/">Bytesed</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="../assets/frontend/js/jquery-migrate-3.3.2.js"></script>
<script>
